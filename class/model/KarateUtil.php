...
class KarateUtil {
	...
	public static function get() {
		if (self::$inst === NULL) self::$inst = new KarateUtil();
		return self::$inst;
	}
	 ...
	 * @param int $idgrado
	 * @return int valore da 0 (nera) a 6 (bianca) o NULL se l'id non corrisponde
	 ...
	 * @param int $kyu valore da 0 (nera) a 6 (bianca)
	 ...
	 * @param int[] $kyu_list array di valori da 0 (nera) a 6 (bianca)
